...
HateProportions %>%
  ...
  ylab("Proportion of All Crimes that were Hate Crimes") +
  scale_x_discrete(limits=c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018)) +
  xlab("Year") +
...
```
It appears that post-2014 every kind of Hate Crime either became a larger proportion of all crimes committed or stayed the same.

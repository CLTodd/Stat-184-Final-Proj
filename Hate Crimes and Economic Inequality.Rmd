...
HateProportions %>%
  ...
  xlab("Year")
```
The proportion of each year's crimes that were Hate Crimes is very small, but this was expected as Hate crimes are a very specific and generally infrequent kind of crime. Once again, we see a general decrease in hate crimes from 2008 to 2014 and an increase from 2008 to 2014. From 2014 to 2018, the proportion of crimes that were hate crimes increased by about 50%. The steepest increase in the proportion of crimes that were Hate Crimes occured in 2016.This plot seems to imply that Hate Crimes started becoming a larger proportion of all crimes committed in 2014. Now we can see that the post-2014 increase is much more consistent than the pre-2014 decrease. We'll apply another linear model, separating at 2014 again.
...
```
It appears that post-2014 every kind of Hate Crime either became a larger proportion of all crimes committed or stayed the same. Racial bias is a consistently dominant amongst the Hate Crimes committed. Religion and Sexual Orientation biases are next, and Gender, Gender Identity, and Disability biases are the least prominent.

### Conclusion
From this data, we can't see a clear trend over the past decade but it does seem like their is some important information help in the 2014-2018 data. Unfortunately, the strength of our conclusions is limited due to the inherent missingess that these data sets suffer from: all of the data is self reported by cities and states across the country. The FBI doesn't require any local governments to submit their crime data to the national government. This gives states and cities the ability to purposefully report less crime in certain areas that they want to make more desirable. In some years, certain states didn't submit any data at all. However it does seem evident that Hate Crimes are making up a larger proportion of all crimes committed in the United States in the most recent years. Hopefully a more complete data set can confirm or deny the intuition formed during this analysis.

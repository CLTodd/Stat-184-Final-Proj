...
HateProportions %>%
  ...
  ggtitle("Proportion of Crimes that were Hate Crimes") +
  scale_x_discrete(limits=c(2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018)) +
  xlab("Year")
```
The proportion of each year's crimes that were hate crimes isvery small, but this is expected as Hate crimes are a very specific and generally infrequent kind of crime. Once again, we see a general decrease in hate crimes from 2008 to 2014 and an increase from 2008 to 2014. This plot seems to imply that Hate Crimes started becoming a larger proportion of all crimes committed in 2014. Now we can see that the post-2014 increase is much more consistent than the pre-2014 decrease. We'll apply another linear model, separateing at 2014 again.

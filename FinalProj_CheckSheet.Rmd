...
(A) .Rmd Line numbers where at least two different data sources are imported:  20 - 52


(B) .Rmd Line numbers for inspecting data intake:  59 - 65
...
(A) .Rmd Line number(s) for general data wrangling: 447 - 495


(B) .Rmd Line number(s) for a join operation: 534 - 557


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 664


(D) .Rmd Line number(s) for use of regular expressions: 194
...
(G) .Rmd Line number(s) for use of loops and/or control flow: 377
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  586, 591

(B) .Rmd Line number(s) for use of multiple aesthetics:  666, 667

(C) .Rmd Line number(s) for use of layered graphics:  582 - 592
